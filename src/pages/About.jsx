      ...
      <div className="card w-full max-w-lg   ">
        <div className="card-body p-6">
          ...
          <p className="text-base text-base-content text-center leading-relaxed mb-6">
            Sparepart Manager adalah aplikasi yang dirancang untuk mengelola stok sparepart,
            transaksi penjualan, dan laporan mekanik secara efisien. Dibuat khusus untuk bengkel dan
            toko sparepart, kami membantu Anda melacak inventaris, mencatat transaksi, dan
            menganalisis performa dengan mudah. Aplikasi ini dibangun menggunakan teknologi modern
            seperti React, React Router, dan Tailwind CSS dengan DaisyUI untuk antarmuka yang
            intuitif.
          </p>
